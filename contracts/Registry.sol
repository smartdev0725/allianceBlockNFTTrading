...
contract Registry is Initializable, Investment, OwnableUpgradeable {
    ...
    function initializeInvestment(
        ...
        require(totalTicketsPerRun_ != 0 && rAlbtPerLotteryNumber_ != 0 && blocksLockedForReputation_ != 0 && lotteryNumbersForImmediateTicket_ != 0, "Cannot initialize with 0 value");
