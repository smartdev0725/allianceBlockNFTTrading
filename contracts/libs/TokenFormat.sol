...
library TokenFormat {
     ...
     */
    function formatTokenId(uint tokenId) internal returns(uint generation, uint loanId) {
     ...
     */
    function getTokenId(uint gen, uint loanId) internal returns(uint tokenId) {
