...
export interface StakerContract extends Truffle.Contract<StakerInstance> {
  "new"(
    _rewardToken: string,
    _stakingToken: string,
    meta?: Truffle.TransactionDetails
  ): Promise<StakerInstance>;
}
...
export interface StakerInstance extends Truffle.ContractInstance {
