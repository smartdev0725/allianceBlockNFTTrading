...
export interface LoanDetailsContract
  extends Truffle.Contract<LoanDetailsInstance> {
  "new"(meta?: Truffle.TransactionDetails): Promise<LoanDetailsInstance>;
}

type AllEvents = never;

export interface LoanDetailsInstance extends Truffle.ContractInstance {
