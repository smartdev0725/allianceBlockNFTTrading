...
export interface LendingTokenContract
  extends Truffle.Contract<LendingTokenInstance> {
  "new"(meta?: Truffle.TransactionDetails): Promise<LendingTokenInstance>;
}
...
export interface LendingTokenInstance extends Truffle.ContractInstance {
